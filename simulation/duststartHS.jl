...
function startparamsHS(no_of_starts,v=26*km/s,l=255.41,b=5.03)
    ...
    for i in 1:no_of_starts
        ...
        start_locvel[1:3,i]= [0AU,0AU,0AU]+95AU*[x,y,z]#+1AU*(rand()-0.5)*[y,-x,0]/norm([y,-x,0])#+80AU*(rand()-0.5)*cross([x,y,z],[y,-x,0]/norm([y,-x,0]))
    end
    return start_locvel
end
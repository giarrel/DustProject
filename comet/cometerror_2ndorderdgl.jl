...
#    ERKN5(),
    ERKN7(),
#    Nystrom4VelocityIndependent(), #probably useless with lorenz force
#    Nystrom5VelocityIndependent(), #probably useless with lorenz force
#    DPRKN4(),
#    DPRKN5(),
#    DPRKN6(),
#    DPRKN6FM(),
...
for method in integrator_methods_rkn
...
# Create the plot
f = Figure()
Axis(f[1, 1];yscale=log10,title = "2nd Order stepsize=$(stepsize/day) days", xlabel="Time [days]", ylabel="Error relative [%]")
